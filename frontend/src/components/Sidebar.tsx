            ...
            <div className="p-4 border-t border-cream-300/60 dark:border-stone-800 flex items-center justify-between">
                <div className="flex items-center gap-1">
                    ...
                    <button
                        ...
                        className={`p-2 rounded-lg transition-colors ${autoPlay
                            ? 'bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400'
                            : 'hover:bg-cream-200 dark:hover:bg-stone-800 text-stone-400 hover:text-stone-600 dark:hover:text-stone-300'
                            }`}
                        aria-label="Lecture audio automatique"
                        title="Lecture audio automatique des versets"
                    >
                        <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                            {autoPlay ? (
